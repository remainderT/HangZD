...
CREATE TABLE `user` (
                        ...
                        `default_public` tinyint(1) DEFAULT 0 COMMENT '默认公开状态 0-不公开;1-公开',
...
CREATE TABLE `question` (
                            ...
                            `solved_flag` tinyint(1)   DEFAULT 0 COMMENT '是否解决 0：未解决 1：已解决且满意 2：已解决但不满意',
                            `create_time` datetime     DEFAULT NULL COMMENT '创建时间',
                            `update_time` datetime     DEFAULT NULL COMMENT '修改时间',
                            `del_flag`   tinyint(1)    DEFAULT NULL COMMENT '删除标识 0：未删除 1：已删除',
                            PRIMARY KEY (`id`),
...
CREATE TABLE `conversation` (
                            ...
                            `question_id` bigint(20) NOT NULL COMMENT '问题ID',
                            `display_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '可见状态 1 user1 删除 2 user2 删除 3 都删除' ,
